...
from src.indexing.chunk_text import BASE_CHUNK_VARIANT, LEGACY_CHUNK_VERSION
...
def _query_chunk_vectors() -> Callable[[str, str, int, str, str], list[ScoredChunk]]:
